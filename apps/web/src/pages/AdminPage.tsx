...
const BASELINE_FIELDS = [
  ...
  {
    key: 'baseline_cov_warn_cop',
    label: 'COP coverage warning threshold',
    help: 'Warn when the share of COP samples inside the golden IQR falls below this fraction.',
    step: 0.01,
    min: 0,
    max: 1,
  },
  {
    key: 'baseline_cov_crit_cop',
    label: 'COP coverage critical threshold',
    help: 'Critical when COP coverage drops under this fraction.',
    step: 0.01,
    min: 0,
    max: 1,
  },
  {
    key: 'baseline_drift_warn_cop',
    label: 'COP median drift warning',
    help: 'Warn when the COP rolling median deviates from baseline by this amount.',
    step: 0.01,
    min: 0,
    max: undefined,
  },
  {
    key: 'baseline_drift_crit_cop',
    label: 'COP median drift critical',
    help: 'Critical alert when COP drift meets or exceeds this value.',
    step: 0.01,
    min: 0,
    max: undefined,
  },
  {
    key: 'baseline_cov_warn_current',
    label: 'Current coverage warning threshold',
    help: 'Warn when compressor current samples inside the baseline IQR fall below this fraction.',
    step: 0.01,
    min: 0,
    max: 1,
  },
  {
    key: 'baseline_cov_crit_current',
    label: 'Current coverage critical threshold',
    help: 'Critical when compressor current coverage drops under this fraction.',
    step: 0.01,
    min: 0,
    max: 1,
  },
  {
    key: 'baseline_drift_warn_current',
    label: 'Current median drift warning (A)',
    help: 'Warn when compressor current deviates from baseline median by this many amps.',
    step: 0.1,
    min: 0,
    max: undefined,
  },
  {
    key: 'baseline_drift_crit_current',
    label: 'Current median drift critical (A)',
    help: 'Critical alert when compressor current drift meets or exceeds this value.',
    step: 0.1,
    min: 0,
    max: undefined,
  },
