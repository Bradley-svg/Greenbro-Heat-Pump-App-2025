...
:root {
  ...
  /* Graphite + accent aliases */
  --gb-graphite-900: #0b0e12;
  --gb-graphite-800: #111822;
  --gb-graphite-100: #eceff3;
  --gb-graphite-050: #f6f7f9;
  --gb-green-500: #39b54a;
  --gb-green-600: #2e9e3f;
...
:root {
  ...
  --gb-report-header-bg: var(--gb-graphite-900);
  --gb-report-header-fg: #ffffff;
  --gb-report-header-accent: var(--gb-green-500);

  --gb-report-footer-bg: var(--gb-graphite-800);
  --gb-report-footer-fg: #e6edf3;
}

/* light-mode email/PDF variant (if we ever flip scheme) */
@media (prefers-color-scheme: light) {
  :root {
    --gb-report-header-bg: #f6f7f9;
    --gb-report-header-fg: #0b0e12;
    --gb-report-header-accent: var(--gb-green-600);

    --gb-report-footer-bg: #eceff3;
    --gb-report-footer-fg: #0b0e12;
  }
}
...
.menu-section button {
  border: 1px solid color-mix(in srgb, var(--gb-muted-soft) 45%, transparent);
  background: color-mix(in srgb, var(--gb-surface, #0f1420) 20%, transparent);
  color: color-mix(in srgb, var(--gb-muted-soft) 70%, #ffffff 10%);
  border-radius: 9px;
  padding: 6px 12px;
  font-size: 13px;
  cursor: pointer;
...
.menu-section button:hover {
  background: color-mix(in srgb, var(--gb-primary-300) 18%, transparent);
  color: #ffffff;
}
...
.hotlist a {
  ...
  padding: 8px 10px;
  border-radius: 10px;
  background: color-mix(in srgb, var(--gb-surface, #0f1420) 86%, transparent);
  color: inherit;
  border: 1px solid color-mix(in srgb, var(--gb-border) 45%, transparent);
}

.hotlist a:hover {
  background: color-mix(in srgb, var(--gb-primary-500) 14%, var(--gb-surface, #0f1420));
  border-color: color-mix(in srgb, var(--gb-primary-500) 38%, transparent);
}
...
.hotlist .dot {
  ...
  height: 8px;
  border-radius: 999px;
  background: var(--gb-chart-warn);
}

.hotlist .dot.crit {
  background: var(--gb-chart-crit);
}
...
.chip.chip-ghost {
  background: color-mix(in srgb, var(--gb-muted-soft) 18%, transparent);
  color: color-mix(in srgb, var(--gb-muted) 72%, #ffffff 8%);
  border-color: color-mix(in srgb, var(--gb-muted-soft) 45%, transparent);
}
